...
- Email collection from participants
...
- `/qrcode event_id` - Generate a QR code for event check-in

## QR Code Check-in

The bot supports a QR code-based check-in system:

1. Administrators generate a QR code for an event using `/qrcode event_id`
